...
def options(socket_conn, Login_Dict, Clearance_Dict, current_user):
    ...
    if choice == "1":
        ...
        if Clearance_Dict[current_user] < 4:
            ...
            current_user = options(socket_conn, Login_Dict, Clearance_Dict, current_user)
            ...
            if new_user[0] in Login_Dict.keys():
                ...
                options(socket_conn, Login_Dict, Clearance_Dict, current_user)
            else:
    ...
    if choice == "2": # LOGOUT
        ...
        login(socket_conn, Login_Dict, Clearance_Dict, current_user)
        pass
...
def login(socket_conn, Login_Dict, Clearance_Dict, current_user):
    ...
    if attempted_login[0] in Login_Dict.keys():
        ...
        if Login_Dict[attempted_login[0]] == attempted_login[1]: # successful login
            ...
            options(socket_conn, Login_Dict, Clearance_Dict, attempted_login[0]) # change current user on successful login
        else:
...
def threaded(test_message, test_list, test_dict, current_user, API_States_Dict, Login_Dict, Clearance_Dict):   # for the very first communcation, server is the receiver
    ...
    current_user = login(c, Login_Dict, Clearance_Dict, current_user) #login is attempted, need this uncommented on both client and server when you want to run it
    ...
    while True:
        ...
        data = c.recv(2048)   # for the very first communcation, server is the receiver
        ...
        if decoded_data == "length received":
            ...
            ##extra stuff here
            decoded_data = verify_input_choice(c, API_States_Dict)
